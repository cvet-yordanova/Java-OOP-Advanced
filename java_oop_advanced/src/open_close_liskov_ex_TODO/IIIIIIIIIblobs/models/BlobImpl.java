package open_close_liskov_ex_TODO.IIIIIIIIIblobs.models;
...
public class BlobImpl implements Blob {
    ...
    public String toString() {
        if (this.getHealth() <= 0) {
            return String.format("BlobImpl %s KILLED", this.getName());
        }

        return String.format("BlobImpl %s: %s HP, %s Damage", this.getName(), this.getHealth(), this.getDamage());
    }
